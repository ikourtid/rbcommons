...
public class RBMatrixUtils {
  ...
  public static boolean isSimilartoIdentityMatrix(RBMatrix matrix, double epsilon) {
  ...
  // A transformation matrix is ortho-normal iff, given any two exposure vectors A and B in orthonormal space,
  ...
  public static boolean isOrthoNormalTransformationMatrix(
    ...
    return isSimilartoIdentityMatrix(rbMatrix(shouldBeIdentity), epsilon);
  }
