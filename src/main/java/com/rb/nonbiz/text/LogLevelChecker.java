 ...
 *
 * <p> We will not unit-test this class because it's hard to simulate log levels in a test,
 * but at least this class is tiny and simple, so it doesn't really need testing. </p>
 */
