...
public interface HasJsonApiDocumentation {
  ...
  /**
   * In certain cases, a JSON API converter may do an in-line conversion of a data class or an enum,
   ...
   * that allows a JSON API converter to supply additional documentation for whatever it's converting "in-line".
   *
  ...
  /**
   * Returns an {@link RBSet} consisting of the 'main' {@link JsonApiDocumentation} (which is required
   * per this interface) and any additional ones, per {@link #getAdditionalJsonApiDocumentation()}.
   *
