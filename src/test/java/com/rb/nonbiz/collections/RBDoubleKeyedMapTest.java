...
public class RBDoubleKeyedMapTest {
  ...
  public static <V> RBDoubleKeyedMap<V> singletonRBDoubleKeyedMap(
  ...
  public void testExactLookup() {
    RBDoubleKeyedMap<String> map = rbDoubleKeyedMapOf(
        1.0, "_1",
        3.0, "_3",
        7.0, "_7");
  ...
  public void testMatcher() {
    DoubleFunction<RBDoubleKeyedMap<String>> maker = diff -> rbDoubleKeyedMapOf(
        1.0 + diff, "_1",
        3.0 + diff, "_3",
        7.0 + diff, "_7");

    RBDoubleKeyedMap<String> exactMap = maker.apply(0.0);
