...
public class MatcherEpsilonsTest {
  ...
  public void testEpsilonsFunctionality() {
    ...
    assertAlmostEquals(epsilon(1e-8), matcherEpsilons.get(Class1.class, DummyClass.class), e);

    assertAlmostEquals(epsilon(1e-8), matcherEpsilons.get(Class2.class),                   e);
    assertAlmostEquals(epsilon(0.28), matcherEpsilons.get(Class2.class, Class2A.class),    e);
    assertAlmostEquals(epsilon(1e-8), matcherEpsilons.get(Class2.class, DummyClass.class), e);

    assertAlmostEquals(epsilon(0.37), matcherEpsilons.get(Class3.class),                   e);
    assertAlmostEquals(epsilon(1e-8), matcherEpsilons.get(Class3.class, DummyClass.class), e);

    assertAlmostEquals(epsilon(0.49), matcherEpsilons.get(Class4.class, "key_for_4"),      e);
    assertAlmostEquals(epsilon(1e-8), matcherEpsilons.get(Class4.class, "wrong_key"),      e);

    assertAlmostEquals(epsilon(1e-8), matcherEpsilons.get(DummyClass.class),               e);
  }
